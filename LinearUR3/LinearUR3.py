...
#                         link3='Finger3Link3')
#         qtest = [0, 0, 0]
#         qtest_transforms = [spb.transl(0.035,0.075,0) @ spb.trotx(-pi),
#                             spb.transl(0.065,0.115,0) @ spb.trotx(-pi),
#                             spb.transl(0.095,0.155,0) @ spb.trotx(-pi),
#                             spb.transl(0.105,0.175,0) @ spb.trotx(-pi),]
#         current_path = os.path.abspath(os.path.dirname(__file__))
...
class LinearUR3(DHRobot3D):
    def __init__(self):         
        ...
        link3D_names = dict(link0 = 'base_link', color0 = (0.8,0.8,0.8,1),      # color option only takes effect for stl file
                            link1 = 'torso_lift_link',color1 = (0.8,0.8,0.8,1),
                            link2 = 'head_pan_link', color2 = (0.8,0.8,0.8,1),
                            link3 = 'head_tilt_link', color3 = (0.8,0.8,0.8,1),
                            link4 = 'shoulder_pan_link', color4 = (0.8,0.8,0.8,1),
                            link5 = 'shoulder_lift_link', color5 = (0.8,0.8,0.8,1),
                            link6 = 'upperarm_roll_link', color6 = (0.8,0.8,0.8,1),
                            link7 = 'elbow_flex_link',color7 = (0.8,0.8,0.8,1),
                            link8 = 'forearm_roll_link',color8 = (0.8,0.8,0.8,1),
                            link9 = 'wrist_flex_link',color9 = (0.8,0.8,0.8,1),
                            link10 = 'wrist_roll_link',color10 = (0.8,0.8,0.8,1),
                            )
    ...
    # -----------------------------------------------------------------------------------#    
    def _create_DH(self):
        links = [rtb.PrismaticDH(theta= pi, a= 0, alpha= pi/2, qlim= [-0.4, 0])]    # Prismatic Link
